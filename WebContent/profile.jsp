				...
				<tr class="row">
					...
					<td class="col"><a href="changepassword.jsp"><input
						...
						href="creditcard.jsp"><input type="button" name="addcr"
							value="Add Credit Card" class="button"></a></td>
				</tr>
			</table>
		</form>
	</div>
					...
					for (int i = 0; i < items.size(); i++) {
						...
						for (int j = 0; j < clients.size(); j++) {
							...
							if (items.get(i).getSoldTo().equals(clients.get(j).getEmail())) {
								...
								out.print("<td style=' border: gray 1px solid;'>" + clients.get(i).getHouseNo() + ", "
										+ clients.get(i).getStreet() + ", " + clients.get(i).getCity() + ", "
										+ clients.get(i).getDistrict() + "</td>");
								out.print("</tr>");
