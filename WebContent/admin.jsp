					...
					<%
						if (admin != null) {
							...
							for (int i = 0; i < feedbacks.size(); i++) {
								...
								out.print(
										"<td style=' border: gray 1px solid;'><form method='post' action='DeleteCommentServlet'><button type='submit' class='button' name='id' value='"
												+ feedbacks.get(i).getId() + "'>&#10006;</button></form></td>");
								out.print("</tr>");
						...
						if (admin != null) {
							...
							for (int i = 0; i < items.size(); i++) {
								...
								if (head == false) {
									...
									out.print("<th style=' border: gray 1px solid;'>Buyer</th>");
									out.print("<th style=' border: gray 1px solid;'>Options</th>");
									out.print("</tr>");
								...
								out.print(
										"<td style=' border: gray 1px solid;'><form method='post' action='DeleteItemServlet'><button type='submit' class='button' name='id' value='"
												+ items.get(i).getItemId() + "'>&#10006;</button></form></td>");
								out.print("</tr>");
